...
const Cartprovider = (props) => {
    ...
    const fetchDisplaydata = async () => {
      try {
        const response = await fetch(
          "https://crudcrud.com/api/971acfe542464d48842e9c28f073460c/display"
        );
  ...
  const addDisplayItemHandler = (data) => {
    fetch("https://crudcrud.com/api/971acfe542464d48842e9c28f073460c/display", {
      method: "POST",
  ...
  const minuslargeqtyHandler = (data) => {
    ...
    // if (IsinDisplay) {
      ...
      fetch(`https://crudcrud.com/api/971acfe542464d48842e9c28f073460c/display/${data.crudid}`,{
        method:'PUT',
